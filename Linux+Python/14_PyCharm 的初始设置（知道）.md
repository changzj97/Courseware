...
![选区_001](https://i.loli.net/2018/06/27/5b3273ba0ee87.png)
...
![选区_002](https://i.loli.net/2018/06/27/5b32740dbbb95.png)

### 2.3 PyCharm 的配置初始界面

* 在初始配置界面，可以通过 `Editor colors and fonts` 选择 **编辑器的配色方案**

![选区_003](https://i.loli.net/2018/06/27/5b32745176103.png)

### 2.4 欢迎界面

* 所有基础配置工作结束之后，就可以看到 `PyCharm` 的 **欢迎界面**了，通过 **欢迎界面** 就可以开始开发 Python 项目了

![选区_004](https://i.loli.net/2018/06/27/5b3274e88216d.png)
...
![选区_005](https://i.loli.net/2018/06/27/5b3275114a7b1.png)
#### 设置项目使用的解释器版本

* 打开的目录如果不是由 `PyCharm` 建立的项目目录，**有的时候** 使用的解释器版本是 `Python 2.x` 的，需要**单独设置解释器的版本**
* 通过 **File** / **Settings...** 可以打开设置窗口，如下图所示：

![选区_006](https://i.loli.net/2018/06/27/5b32753422294.png)
...
![选区_007](https://i.loli.net/2018/06/27/5b327575f3fc7.png)

![选区_008](https://i.loli.net/2018/06/27/5b327598cb275.png)
...
![选区_009](https://i.loli.net/2018/06/27/5b3275ca14b1a.png)
